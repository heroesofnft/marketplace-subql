...
export declare namespace ReserveAuctionCoreErc20 {
...
export interface ReserveAuctionCoreErc20Interface extends utils.Interface {
  functions: {
    ...
    "createAuction(address,uint256,uint256,uint256,address,uint256,address)": FunctionFragment;
...
export interface AuctionBidEventObject {
  ...
  firstBid: boolean;
  extended: boolean;
  auction: ReserveAuctionCoreErc20.AuctionStructOutput;
}
export type AuctionBidEvent = TypedEvent<
  [
    ...
    boolean,
    boolean,
    ReserveAuctionCoreErc20.AuctionStructOutput
  ],
...
export type AuctionCanceledEvent = TypedEvent<
  [string, BigNumber, ReserveAuctionCoreErc20.AuctionStructOutput],
...
export interface ReserveAuctionCoreErc20 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ReserveAuctionCoreErc20Interface;
  ...
  functions: {
    ...
    createAuction(
      ...
      _bidCurrency: PromiseOrValue<string>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
