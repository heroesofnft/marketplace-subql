...
import type {
  ...
  ReserveAuctionCoreErc20Interface,
} from "../ReserveAuctionCoreErc20";
  ...
  },
  {
    ...
    inputs: [
      ...
      },
      {
        ...
        indexed: false,
        internalType: "struct ReserveAuctionCoreErc20.Auction",
        name: "auction",
        type: "tuple",
      },
    ],
...
export class ReserveAuctionCoreErc20__factory {
  static readonly abi = _abi;
  static createInterface(): ReserveAuctionCoreErc20Interface {
    return new utils.Interface(_abi) as ReserveAuctionCoreErc20Interface;
  }
  static connect(
    address: string,
